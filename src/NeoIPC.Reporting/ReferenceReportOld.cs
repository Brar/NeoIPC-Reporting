...
sealed class ReferenceReportOld : NeoIPCReport
{
    ...
    public ReferenceReportOld(DateOnly? reportingPeriodFrom,
        ...
        ILogger<ReferenceReportOld> logger) : base("Reference Report", environment, logger)
    {
    ...
    public static async Task<IResult> Get(
        ...
        [FromServices] ILogger<ReferenceReportOld> logger,
        HttpRequest httpRequest,
        CancellationToken cancellationToken
    )
    {
       using var report = new ReferenceReportOld(reportingPeriodFrom, reportingPeriodTo, birthWeightFrom, birthWeightTo, gestationalAgeFrom,
    ...
    static readonly FrozenDictionary<string, MediaTypeHeaderValue> SupportedMediaTypeHeaderValues =
    ...
    static readonly FrozenDictionary<string, string> TranslatedFiles;

    static ReferenceReportOld()
    {
